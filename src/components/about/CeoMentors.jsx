...
const mentorsData = [
    ...
    },
    {
        ...
        designation: 'Chủ tịch Sáng lập Viện Lãnh đạo,\nQuản trị và Quản lý Việt Nam',
            ...
            <div className="container">
                <div className="text-center" style={{ marginBottom: '60px' }}>
                    ...
                    <p style={{ color: '#555', fontSize: '15.5px', maxWidth: '850px', margin: '0 auto', lineHeight: '1.7' }}>
                        CEO Mentoring được tổ chức liên tục với sự đồng hành của các Nhà lãnh đạo doanh nghiệp hàng đầu. Mỗi Mentor mang đến một góc nhìn riêng, giúp cộng đồng CEO tiếp cận nhiều kinh nghiệm lãnh đạo trong những bối cảnh và lĩnh vực khác nhau.
                    </p>
                </div>
                ...
                <div className="row justify-content-center text-center">
                    {mentorsData.map((mentor) => {
                        ...
                        return (
                        <div key={mentor.id} className={mentor.colClass} style={{ paddingLeft: '15px', paddingRight: '15px' }}>
                            <div className={innerClass} style={{
                                maxWidth: mentor.colClass.includes('col-lg-4') ? '92%' : '100%',
                                width: '100%'
                            }}>
                                <div className="ceo-mentor-image" style={{ 
                                borderRadius: '20px', 
                                overflow: 'hidden', 
                                position: 'relative', 
                                width: '100%', 
                                aspectRatio: mentor.isMain ? '3/4.15' : (mentor.colClass.includes('col-lg-4') ? '3/4' : '3/4.2'), 
                            ...
                            <div style={{ minHeight: '90px', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
                                <h4 style={{ color: '#cc0000', fontSize: '17px', fontWeight: '800', margin: '0 0 10px 0', fontFamily: 'var(--font-montserrat)', textTransform: 'uppercase' }}>
                                    {mentor.name}
                                </h4>
                                <p style={{ color: '#555', fontSize: '14.5px', margin: 0, whiteSpace: 'pre-line', lineHeight: '1.5' }}>
                                    {mentor.designation}
                                </p>
                            </div>
                            </div>
