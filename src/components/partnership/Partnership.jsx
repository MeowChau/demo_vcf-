                ...
                <div className="row mb-5">
                    <div className="col-12 mb-4">
                        ...
                        <p style={{ color: '#555', fontSize: '15px', lineHeight: '1.6' }}>
                            ASIA CEO COMMUNITY is working in partnership with both global and local organizations across nearly every sector and industry to find new solutions to global business challenges.
                        </p>
                    </div>
                    ...
                    <div className="col-md-7 mb-4 pr-md-4">
                        ...
                        <form style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            ...
                            <textarea placeholder="Message" rows="6" style={{ width: '100%', padding: '12px', backgroundColor: '#f5f5f5', border: 'none', resize: 'none' }}></textarea>
                    ...
                    <div className="col-md-5 mb-4">
                        <img src="/assets/img/partnership/8f26dd417e9b44dba5e1039a4989b477.avif" alt="Partnership Handshake" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                    </div>
                </div>
