    ...
    return (
        <div className="aiim-page pt-100 pb-100" style={{ backgroundColor: '#fff' }}>
            <div className="container" style={{ maxWidth: '1000px' }}>
                ...
                {/* Images Section */}
                <div className="images-section mb-5">
                    <img src="/assets/img/leadershipWorkshops/AIIM Page 1.avif" alt="AIIM Page 1" style={{ width: '100%', display: 'block', marginBottom: '0' }} />
                    <img src="/assets/img/leadershipWorkshops/AIIM V2.avif" alt="AIIM V2" style={{ width: '100%', display: 'block', marginBottom: '0' }} />
                    <img src="/assets/img/leadershipWorkshops/AIIM Page 3.avif" alt="AIIM Page 3" style={{ width: '100%', display: 'block', marginBottom: '30px' }} />
                </div>
                ...
                <div className="form-section mt-5">
                    ...
                    <p style={{ color: '#d9232d', fontWeight: 'bold', marginBottom: '40px', fontSize: '15px' }}>Workshop Fee (HKD) &nbsp;&nbsp;&nbsp;7,600</p>
                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="row align-items-start mb-4 pt-3">
                            <div className="col-md-3"><label style={labelStyle}>Are you 18 years old or older? <span style={{color: '#d9232d'}}>*</span></label></div>
                            <div className="col-md-9">
                                <div className="mb-2"><input type="radio" name="age" id="age_yes" className="mr-2" required /> <label htmlFor="age_yes" style={{ color: '#555' }}>Yes</label></div>
                                <div><input type="radio" name="age" id="age_no" className="mr-2" required /> <label htmlFor="age_no" style={{ color: '#555' }}>No</label></div>
                            </div>
                        </div>

                        <div className="row align-items-center mb-5 pt-3 pb-3">
                            <div className="col-md-3"><label style={labelStyle}>Upload Your Business Card</label></div>
                            <div className="col-md-4 text-center mb-3 mb-md-0">
                                <button type="button" style={uploadBtnStyle}>
                                    <i className="fas fa-plus" style={{ marginRight: '8px' }}></i> UPLOAD BUSINESS CARD
                                </button>
                                <p style={{ fontSize: '12px', color: '#aaa', marginTop: '10px', marginBottom: 0 }}>Max File Size 15MB</p>
                            </div>
                            <div className="col-md-2 text-md-right"><label style={labelStyle}>Upload Your Profile Photo</label></div>
                            <div className="col-md-3 text-center">
                                <button type="button" style={uploadBtnStyle}>
                                    <i className="fas fa-plus" style={{ marginRight: '8px' }}></i> UPLOAD PROFILE PHOTO
                                </button>
                                <p style={{ fontSize: '12px', color: '#aaa', marginTop: '10px', marginBottom: 0 }}>Max File Size 15MB</p>
                            </div>
                        </div>
