...
export const metadata = {
    title: "Diễn đàn CEO Việt Nam - Consulting Business - Insurance"
}
    ...
    return (
        <>
            <LayoutStyle4>
                ...
                <TeamStyle2 hasText={false} sectionClass="secondary" />
                <MissionStyle1 />
                <TestimonialStyle1 sectionClass="secondary bg-gray" shapeBlue={true} />
                <BlogStyle1 sectionClass="secondary" titleClass="secondary" />
            </LayoutStyle4>
        </>
    );
};
